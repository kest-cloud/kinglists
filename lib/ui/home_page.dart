...
import 'package:kingslist/models/task.dart';
import 'task_create_page.dart';
import 'package:kingslist/bloc/project_bloc.dart';
import 'package:kingslist/utils/datetime_extension.dart';
                      ...
                      for (var p in snapshot.data)
                        Container(
                          ...
                          child: ListTile(
                            ...
                            subtitle: Text(
                                "${p.tasks.where((t) => t.isDone).toList().length}/${p.tasks.length}"),
                            onTap: () {
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  ...
                                  Text(
                                      e.dueDate == null
                                          ? ""
                                          : "Due by ${e.dueDate.toLocal().toCustomString()}",
                                      style: TextStyle(color: Colors.black54)),
                                  Divider(),
                                  Text(
                                      e.createdDate == null
                                          ? ""
                                          : "Created on ${e.createdDate.toLocal().toCustomString()}",
                                      style: TextStyle(color: Colors.black54)),
                                  SizedBox(height: 12)
                                ],
                              ),
            ...
            actions: <Widget>[
              ...
              CupertinoActionSheetAction(
                ...
                onPressed: () {
                  ...
                  Navigator.pop(context);
                  Navigator.push(context,
                      MaterialPageRoute(builder: (_) => IconPage(project: p)));
                },
              ),
              CupertinoActionSheetAction(
